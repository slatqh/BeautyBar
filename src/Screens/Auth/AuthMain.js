      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1, alignSelf: 'center', justifyContent: 'center' }}>
          ...
          <Text style={{ fontFamily: 'montserrat', color: '#7f8184', fontSize: 12 }}>
                BEAUTY BAR FOR
            <Text style={{ fontFamily: 'montserrat-semiBold', fontSize: 12 }}>BUSINESS</Text>
          </Text>
        </View>
      </View>
    );
...
const styles = StyleSheet.create({
  image: {
    justifyContent: 'center', alignSelf: 'center', width: 300, height: 200,
  },
  container: {
    flex: 1, alignSelf: 'center',
  },
  wrapper: {
    flexDirection: 'row', alignItems: 'center', alignSelf: 'center', padding: 20,
  },
  wrapperOr: {
    width: 50, borderTopWidth: 4, borderTopColor: '#cfd8dc',
  },
  or: {
    paddingHorizontal: 10, fontFamily: 'Montserrat', color: '#7f8184',
  },
  googleImage: {
